 ...
 */
package org.myclothstore.test.setup;
...
import org.myclothstore.test.constants.MyclothstoreTestConstants;
import org.myclothstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MyclothstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myclothstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myclothstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myclothstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/myclothstoretest/import/csquotes.impex");
		}
	}
}
