 ...
 */
package org.myclothstore.core.suggestion;
...
import org.myclothstore.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/myclothstorecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
