 ...
 */
package org.myclothstore.core.constants;

/**
 * Global class for all MyclothstoreCore constants. You can add global constants for your extension into this class.
 */
public final class MyclothstoreCoreConstants extends GeneratedMyclothstoreCoreConstants
{
	public static final String EXTENSIONNAME = "myclothstorecore";


	private MyclothstoreCoreConstants()
	{
		//empty
	}
