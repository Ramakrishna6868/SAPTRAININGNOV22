...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myclothstorestorefront/electronics/en",
						"https://electronics.local:9002/myclothstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/myclothstorestorefront/electronics/en",
						"https://electronics.local:9002/myclothstorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myclothstorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/myclothstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/myclothstorestorefront/electronics/en",
						"https://electronics.local:9002/myclothstorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myclothstorestorefront",
						"https://electronics.local:9002/myclothstorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/myclothstorestorefront",
						"https://electronics.local:9002/myclothstorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/myclothstorestorefront/electronics/en",
						"https://electronics.local:9002/myclothstorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
