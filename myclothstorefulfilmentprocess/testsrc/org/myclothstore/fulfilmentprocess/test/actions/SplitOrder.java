 ...
 */
package org.myclothstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MyclothstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MyclothstoreFulfilmentProcessConstants.PARENT_PROCESS);
